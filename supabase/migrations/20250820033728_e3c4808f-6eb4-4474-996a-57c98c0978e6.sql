-- Primeiro, corrigir a função auto_setup_protheus_table que tem o erro
DROP FUNCTION IF EXISTS public.auto_setup_protheus_table();

-- Remover o event trigger problemático
...
BEGIN
    ...
    LOOP
        ...
        EXCEPTION WHEN OTHERS THEN
            ...
            RAISE NOTICE 'Erro ao configurar tabela %: %', table_record.supabase_table_name, SQLERRM;
        END;
    END LOOP;
END
$$;
