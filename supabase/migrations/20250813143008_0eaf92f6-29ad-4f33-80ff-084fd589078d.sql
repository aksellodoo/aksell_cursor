-- Fix the site_product_applications_map table structure
DROP TABLE IF EXISTS public.site_product_applications_map CASCADE;
...
CREATE POLICY "Users can update application mappings" 
ON public.site_product_applications_map 
FOR UPDATE 
USING (
