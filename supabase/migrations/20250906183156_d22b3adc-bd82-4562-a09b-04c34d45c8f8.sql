-- Drop and recreate the function with correct material types table
DROP FUNCTION IF EXISTS public.get_purchases_economic_groups_paginated(integer,integer,text,text,text);
