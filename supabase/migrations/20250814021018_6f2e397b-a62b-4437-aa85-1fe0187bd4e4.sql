-- Corrigir função generate_device_fingerprint para usar sha256
...
-- Corrigir função is_device_trusted para remover parâmetro user_id desnecessário
...
-- Criar função cleanup_expired_trusted_devices que estava faltando
