...
-- Make id_grupo the primary key and drop the old primary key
...
-- Update protheus_customer_group_units to reference id_grupo instead of composite key
ALTER TABLE protheus_customer_group_units 
DROP CONSTRAINT IF EXISTS protheus_customer_group_units_group_id_fkey;

-- Add new foreign key to id_grupo
ALTER TABLE protheus_customer_group_units 
