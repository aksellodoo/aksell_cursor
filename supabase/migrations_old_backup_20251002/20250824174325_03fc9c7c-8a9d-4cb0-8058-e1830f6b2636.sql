-- Step 2: Clean up orphaned references now that columns are nullable
...
-- Delete orphaned workflow approvals if table exists
DO $$ 
BEGIN
...
-- Delete orphaned approval tokens
