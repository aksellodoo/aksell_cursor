-- Drop the problematic overload that's not being used
DROP FUNCTION IF EXISTS public.query_dynamic_table(text, text[], integer, integer, text, jsonb, text, text);

-- Replace the existing function with the corrected version that uses array_append
