-- 1. Adicionar novas colunas à tabela workflows primeiro
...
-- 2. Criar o novo enum confidentiality_level_new
...
-- 8. Atualizar as políticas RLS para usar a nova função
...
-- 9. Aplicar as mesmas mudanças à tabela workflow_auto_triggers
