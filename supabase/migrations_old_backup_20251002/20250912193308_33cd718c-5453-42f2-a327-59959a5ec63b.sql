...
-- Convert any invalid statuses to 'active'
UPDATE public.documents 
SET status = 'active' 
WHERE status::text NOT IN ('aprovado', 'pendente_revisao', 'pendente_aprovacao', 'rejeitado', 'obsoleto', 'processing', 'active', 'error');
